...
$SiteURLs = Import-Csv -Path "C:\temp\GroupSitePermission.csv"
$UserAccount="i:0#.f|membership|haoli@hali3.onmicrosoft.com"
...
#sharepoint online powershell to get user permissions Applied on a particular Object, such as: Web, List
...
Foreach($siteURL in $SiteURLs.sharepointsiteurl)
{
